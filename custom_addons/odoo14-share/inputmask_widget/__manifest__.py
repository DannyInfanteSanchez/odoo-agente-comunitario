...
Based on jquery.inputmask 3.x & Tipso `Docs in GitHub
<http://robinherbots.github.io/Inputmask/> <https://tipso.object505.com>`_.
...
| Tooltip plugin that displays a responsive, animated, fully customizable tooltip when the visitor hovers over the matched element.
